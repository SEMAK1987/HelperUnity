...
## 1. Общая информация
- **Версия Помощника:** 13.3.7
- **Описание:** Гибридный ИИ-помощник (Online/Offline) для Unity & Blender. Поддержка Ollama, миграция на Unity 6, сохранение чата, поддержка архивов, RPG систем, алхимии, цветовой градации артефактов, отложенного анализа файлов и самовосстановление.
...
## 6. Новые возможности ИИ (v13.3.7)
...
- **Alchemy & Potion System (NEW):** Создание зелий (Мана, Сила, Удача и др.) с рангами от E до SSS (5% - 150%+). Механики варки, дистилляции и влияния навыков.
- **Artifact Color Ranks (NEW):** Система цветовой градации артефактов в зависимости от их навыков и редкости.
- **Deferred File Analysis (NEW):** Возможность прикреплять файлы к сообщению перед отправкой. ИИ анализирует проблему комплексно вместе со всеми вложениями.
...
- **Типы зелий:** Мана, Сила, Удача, Атака, Уклонение, Броня, Интеллект, Маг/Физ атака.
- **Ранги (E-SSS):** E (5-10%), D (11-20%), C (21-35%), B (36-50%), A (51-70%), S (71-90%), SS (91-120%), SSS (121-150%+).
- **Механики:** Сбор трав, использование катализаторов, дистилляция, влияние уровня навыка на результат.
