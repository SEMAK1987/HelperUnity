...
> **ВНИМАНИЕ:** Этот документ является "источников истины" для всего проекта. Он содержит полную структуру интерфейса, базу знаний агентов, инструкции по самовосстановлению и описание возможностей ИИ v18.12.03.

## 1. Общая информация
- **Версия Помощника:** 18.12.03
- **Описание:** Гибридный ИИ-помощник нового поколения (v18.12.03 - BattleScene UI Overlay Suppression Fix) для Unity 6 (6000.3.10f1), Blender 5.2 и Godot 4.4. Интеграция адаптивного переключения ввода, калибровка зум-параметров при высадке, позиционирование маркеров по Z=-2.0f, сохранение прогресса, моделирование отрядов, и авто-скрытие интерфейса при осаде замков во время нахождения на сцене BattleScene.
...
- **Флаги:** [QUANTUM_LINK_ACTIVE], [KNOWLEDGE_STORAGE_SYNC], [V18_12_03_FATE_MASTER]
