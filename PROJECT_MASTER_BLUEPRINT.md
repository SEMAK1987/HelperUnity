...
> **ВНИМАНИЕ:** Этот документ является "источников истины" для всего проекта. Он содержит полную структуру интерфейса, базу знаний агентов, инструкции по самовосстановлению и описание возможностей ИИ v18.12.02.

## 1. Общая информация
- **Версия Помощника:** 18.12.02
- **Описание:** Гибридный ИИ-помощник нового поколения (v18.12.02 - BattleScene Arena Loading Integration) для Unity 6 (6000.3.10f1), Blender 5.2 и Godot 4.4. Интеграция адаптивного переключения ввода, калибровка зум-параметров при высадке, позиционирование маркеров по Z=-2.0f, сохранение прогресса, моделирование отрядов, и авто-переход на сцену BattleScene при осаде замков.
...
- **Флаги:** [QUANTUM_LINK_ACTIVE], [KNOWLEDGE_STORAGE_SYNC], [V18_12_02_FATE_MASTER]
