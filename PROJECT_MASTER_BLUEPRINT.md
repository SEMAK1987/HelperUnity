...
## 1. Общая информация
- **Версия Помощника:** 15.10.0
- **Описание:** Гибридный ИИ-помощник (Online/Offline) для Unity, Blender, GIMP и Redot (Godot). Поддержка Ollama, миграция на Unity 6, перенос проектов Unity -> Godot, сохранение чата и самовосстановление.
...
### Вкладки
- **MIGRATION**: Центр миграции проектов (Unity -> Godot)
