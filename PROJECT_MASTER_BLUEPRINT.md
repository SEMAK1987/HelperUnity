...
> **ВНИМАНИЕ:** Этот документ является "источников истины" для всего проекта. Он содержит полную структуру интерфейса, базу знаний агентов, инструкции по самовосстановлению и описание возможностей ИИ v18.12.01.

## 1. Общая информация
- **Версия Помощника:** 18.12.01
- **Описание:** Гибридный ИИ-помощник нового поколения (v18.12.01 - Full Continent Completed Overlay & Cheat Conquer All Castles) для Unity 6 (6000.3.10f1), Blender 5.2 и Godot 4.4. Интеграция адаптивного переключения ввода, калибровка зум-параметров при высадке, позиционирование маркеров по Z=-2.0f, сохранение прогресса, моделирование отрядов, и авто-переход на следующий континент при победе.
