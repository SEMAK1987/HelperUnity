...
## 1. Общая информация
- **Версия Помощника:** 17.18.29
- **Описание:** Гибридный ИИ-помощник нового поколения (Online/Offline/No-Internet) для Unity 6 (6000.3.5), Blender 5.2 и Godot 4.4. Поддержка процедурной генерации миров 'Континент Судьбы', автоматический аудит сцен и 12,500+ видео уроков.
