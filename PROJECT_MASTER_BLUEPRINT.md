...
> **ВНИМАНИЕ:** Этот документ является "источников истины" для всего проекта. Он содержит полную структуру интерфейса, базу знаний агентов, инструкции по самовосстановлению и описание возможностей ИИ v18.12.04.

## 1. Общая информация
- **Версия Помощника:** 18.12.04
- **Описание:** Гибридный ИИ-помощник нового поколения (v18.12.04 - BattleScene Dual Grid Generator System) для Unity 6 (6000.3.10f1), Blender 5.2 и Godot 4.4. Поддерживает процедурную генерацию тактических арен в Blender (blender_battle_grid_gen.py) и Unity C# (BattleGridGenerator.cs) с динамической регулировкой размеров, ячеек, отступов и цветов команд.
...
- **Флаги:** [QUANTUM_LINK_ACTIVE], [KNOWLEDGE_STORAGE_SYNC], [V18_12_04_FATE_MASTER]
