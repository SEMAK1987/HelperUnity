...
> **ВНИМАНИЕ:** Этот документ является "источников истины" для всего проекта. Он содержит полную структуру интерфейса, базу знаний агентов, инструкции по самовосстановлению и описание возможностей ИИ v18.11.26.

## 1. Общая информация
- **Версия Помощника:** 18.11.26
- **Описание:** Гибридный ИИ-помощник нового поколения (v18.11.26 - Tactical Spy Report High-Density Grids) для Unity 6 (6000.3.10f1), Blender 5.2 и Godot 4.4. Интеграция адаптивного переключения ввода, калибровка зум-параметров при высадке, позиционирование маркеров по Z=-2.0f, сохранение прогресса и моделирования отрядов, высокодетализированный визуальный шпионаж за цитаделями врагов.
...
- **Флаги:** [QUANTUM_LINK_ACTIVE], [KNOWLEDGE_STORAGE_SYNC], [V18_11_26_FATE_MASTER]
