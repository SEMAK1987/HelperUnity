...
## 1. Общая информация
- **Версия Помощника:** 18.12.06
- **Описание:** Гибридный ИИ-помощник нового поколения (v18.12.06 - Battle Grid Unification & Automatic Zero Baked Colors System) для Unity 6 (6000.3.10f1), Blender 5.2 и Godot 4.4. Интеграция адаптивного переключения ввода, калибровка зум-параметров при высадке, позиционирование маркеров по Z=-2.0f, сохранение прогресса и моделирования отрядов.
...
## 13. История изменений (v18.12.06)
- **v18.12.06:** Battle Grid Unification & Automatic Zero Baked Colors System • Solved baked tile coloring visual noise by implementing `unifyGridMaterials` in `TacticalBattleGrid.cs`, overriding baked red/blue/green models with a standard neutral gray material from a reference cell. Fully built `ToggleDeploymentZones(bool show)` to dynamically toggle red/blue overlays off at battle start, while keeping hover gold highlights crisp and functional.
