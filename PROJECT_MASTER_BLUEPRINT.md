...
## 1. Общая информация
- **Версия Помощника:** 13.3.5
- **Описание:** Гибридный ИИ-помощник (Online/Offline) для Unity & Blender. Поддержка Ollama, миграция на Unity 6, сохранение чата, поддержка архивов, RPG систем, цветовой градации артефактов и самовосстановление.
...
## 6. Новые возможности ИИ (v13.3.5)
...
- **Artifact Color Ranks (NEW):** Визуальная система градации артефактов по цветам (от Белого до Божественного) в зависимости от активных/пассивных навыков и ранга.
...
### Система Артефактов
- **Цветовая градация (1-3 тир):** Белый, Зелёный, Синий, Фиолетовый, Розовый (5 рангов).
- **Цветовая градация (4-6 тир):** Белый, Зелёный, Синий, Фиолетовый, Розовый, Пурпурный, Золотой, Легендарный, Полубожественный, Божественный (10 рангов).
- **Логика:** Цвет меняется динамически в зависимости от активных и пассивных навыков предмета.
