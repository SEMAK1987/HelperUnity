...
## 13. Новые возможности ИИ
- **Мультимодальность (Vision):** ИИ теперь может анализировать скриншоты и изображения прямо в чате.
- **Контекстная память:** ИИ помнит последние 10 сообщений в диалоге.
- **Статическая раздача:** Сервер теперь отдает файлы из /uploads для анализа ИИ.
