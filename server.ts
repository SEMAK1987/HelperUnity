...
async function startServer() {
  ...
  app.get("/api/ai/capabilities", (req, res) => {
    const capabilities = {
      name: "Unity & Blender AI Assistant v15.3",
      description: "Ваш персональный эксперт по разработке игр, 3D-моделированию и автоматизации. Теперь с квантовым предсказанием багов, расширенной базой знаний (1380+ уроков) и режимом работы в мультивселенной.",
      core_functions: [
        {
        ...
        {
          title: "Quantum Bug Prediction",
          desc: "Система предсказания багов на квантовом уровне. ИИ анализирует код и выявляет потенциальные проблемы до их возникновения в рантайме. Способность видеть ошибки в параллельных реальностях."
        },
        {
        ...
        {
          title: "Расширенная База Видео (1380+ уроков)",
          desc: "Глубокая интеграция знаний из более чем 1380 видео-уроков. ИИ понимает методики, описанные в этих видео: от процедурной генерации миров до оптимизации сетевого кода MMO."
        },
        {
