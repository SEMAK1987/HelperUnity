...
async function startServer() {
  ...
  app.get("/api/ai/capabilities", (req, res) => {
    const capabilities = {
      name: "Unity & Blender AI Assistant v15.2",
      description: "Ваш персональный эксперт по разработке игр, 3D-моделированию и автоматизации. Теперь с расширенной базой знаний (1310+ уроков), режимом работы без интернета и возможностями отладки в мультивселенной.",
      core_functions: [
        {
        ...
        {
          title: "Расширенная База Видео (1310+ уроков)",
          desc: "Глубокая интеграция знаний из более чем 1310 видео-уроков. ИИ не просто знает ссылки, он понимает методики, описанные в этих видео, и может применять их для решения ваших задач."
        },
        {
          title: "Hybrid No-Internet Mode",
          desc: "Возможность работы в условиях полного отсутствия интернета. ИИ использует локальные базы знаний и кэшированные данные для обеспечения бесперебойной помощи."
        },
        {
