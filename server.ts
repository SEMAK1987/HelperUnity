...
async function generateMasterBlueprint() {
  try {
    ...
    md += `- **Флаги:** [QUANTUM_LINK_ACTIVE], [KNOWLEDGE_STORAGE_SYNC], [V18_11_0_FATE_MASTER]\n\n`;
    ...
    md += `### ОБРАЗОВАТЕЛЬНЫЙ ХАБ (v18.11.0 Sync)\n`;
    ...
    md += `## 13. История изменений (v18.11.0)\n`;
