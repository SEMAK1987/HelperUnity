...
async function startServer() {
  ...
  app.get("/api/ai/capabilities", (req, res) => {
    const capabilities = {
      name: "Unity & Blender AI Assistant v14.9",
      description: "Ваш персональный эксперт по разработке игр, 3D-моделированию и автоматизации. Теперь с расширенной базой знаний (975+ уроков) и продвинутыми возможностями ИИ.",
      core_functions: [
        {
        ...
        {
          title: "Расширенная База Видео (975+ уроков)",
          desc: "Глубокая интеграция знаний из более чем 975 видео-уроков. ИИ не просто знает ссылки, он понимает методики, описанные в этих видео, и может применять их для решения ваших задач."
        },
        {
