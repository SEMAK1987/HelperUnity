    ...
    const capabilities = {
      ...
      core_functions: [
        ...
        },
        {
          ...
          desc: "Система предсказания багов на квантовом уровне. ИИ анализирует код и выявляет потенциальные проблемы до их возникновения в рантайме."
        },
        {
        ...
        },
        {
          ...
          desc: "Глубокая интеграция знаний из более чем 1380 видео-уроков. ИИ не просто знает ссылки, он понимает методики, описанные в этих видео, и может применять их для решения ваших задач."
        },
        {
          title: "Hybrid & Quantum Mode",
          desc: "Возможность работы в условиях полного отсутствия интернета с использованием квантовых алгоритмов локальной обработки данных."
        },
        {
