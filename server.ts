...
async function startServer() {
  ...
  app.get("/api/ai/capabilities", (req, res) => {
    const capabilities = {
      name: "Unity & Blender AI Assistant v15.13.0 (PRO Edition)",
      ...
      core_functions: [
        {
          ...
          desc: "Максимальный интеллект уровня SSS+. Прямая нейронная связь с облачными кластерами Google и Galactic Network. Анализ архитектуры, генерация сложнейшего кода, предсказание трендов и работа с терабайтными датасетами. Использует технологию Quantum Beam и доступ к Galactic Network."
        },
        {
          title: "Offline Mode (Ollama Private)",
          desc: "Полная цифровая секретность. Работает локально на вашем GPU/NPU. Не требует интернета для кодинга и отладки. Использует квантово-весовое сжатие моделей, Ethernet Telepathy и Quantum Sync для мгновенной связи данных."
        },
        {
          title: "No-Internet Core (Knowledge DB v3)",
          desc: "Режим 'Черный Ящик'. Мгновенный доступ к 3500+ видео, тысячам скриптов и API справочникам Unity/Blender без интернета. Поиск через бинарные индексы SSD. Ответы приходят моментально. Содержит полную копию всех обучающих данных."
        },
        {
        ...
        {
          title: "RPG, Asset & Crafting Forge Core",
