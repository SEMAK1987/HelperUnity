...
async function startServer() {
  ...
  app.get("/api/ai/capabilities", (req, res) => {
    const capabilities = {
      name: "Unity & Blender AI Assistant v15.1",
      description: "Ваш персональный эксперт по разработке игр, 3D-моделированию и автоматизации. Теперь с расширенной базой знаний (1250+ уроков) и возможностями отладки в мультивселенной.",
      core_functions: [
        {
        ...
        {
          title: "Расширенная База Видео (1250+ уроков)",
          desc: "Глубокая интеграция знаний из более чем 1250 видео-уроков. ИИ не просто знает ссылки, он понимает методики, описанные в этих видео, и может применять их для решения ваших задач."
        },
        {
