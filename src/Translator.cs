...
public class Translator : MonoBehaviour
{
    ...
    private static string[,] LineText = 
    {
        ...
        #endregion
        #region 2 - Deutsch
        { "Start", "Weiter", "Optionen", "Credits", "Beenden", "Ton", "Musik", "Inversion", "Sensibilität", "Grafik", "Auflösung", "Vollbild", "Sprache", "Laden...", "Speicher überschreiben?", "Neues Spiel", "Gespeichert", "Neustart", "Steuerung", "Zurück", "Qualität", "Maus Inversion", "Sensibilität", "Willkommen...", "Slot ", "Slot wählen", "(Überschreiben)", "(Leer)", "Hallo...", "Mäuse...", "Danke...", "Hallo...", "Besetzt...", "E drücken", "Weiter", "Speichern", "Mäuse: ", "Sehr Niedrig", "Niedrig", "Mittel", "Hoch", "Sehr Hoch", "Ultra" },
        #endregion
        #region 3 - Français
        { "Démarrer", "Continuer", "Options", "Crédits", "Quitter", "Son", "Musique", "Inversion", "Sensibilité", "Graphiques", "Résolution", "Plein écran", "Langue", "Chargement...", "Écraser?", "Nouvelle partie", "Sauvegardé", "Relancer", "Commandes", "Retour", "Qualité", "Inversion", "Sensibilité", "Bienvenue...", "Slot ", "Slot", "(Écraser)", "(Vide)", "Salut...", "Souris...", "Merci...", "Salut...", "Occupé...", "E", "Continuer", "Sauvegarder", "Souris: ", "Très Bas", "Bas", "Moyen", "Haut", "Très Haut", "Ultra" },
        #endregion
        #region 4 - Español
        { "Inicio", "Continuar", "Opciones", "Créditos", "Salir", "Sonido", "Música", "Inversión", "Sensibilidad", "Gráficos", "Resolución", "Pantalla completa", "Idioma", "Cargando...", "Sobreescribir?", "Nueva partida", "Guardado", "Reiniciar", "Controles", "Atrás", "Calidad", "Inversión", "Sensibilidad", "Bienvenido...", "Slot ", "Slot", "(Sobreescribir)", "(Vacío)", "Hola...", "Ratones...", "Gracias...", "Hola...", "Ocupado...", "E", "Continuar", "Guardar", "Ratones: ", "Muy Bajo", "Bajo", "Medio", "Alto", "Muy Alto", "Ultra" },
        #endregion
        #region 5 - Português
        { "Iniciar", "Continuar", "Opções", "Créditos", "Sair", "Som", "Música", "Inversão", "Sensibilidade", "Gráficos", "Resolução", "Tela cheia", "Idioma", "Carregando...", "Sobrescrever?", "Novo jogo", "Gravado", "Reiniciar", "Controles", "Voltar", "Qualidade", "Inversão", "Sensibilidade", "Bem-vindo...", "Slot ", "Slot", "(Sobrescrever)", "(Vazio)", "Olá...", "Ratos...", "Obrigado...", "Olá...", "Ocupado...", "E", "Continuar", "Salvar", "Ratos: ", "Muito Baixo", "Baixo", "Médio", "Alto", "Muito Alto", "Ultra" },
        #endregion
        #region 6 - 日本語
        { "スタート", "続行", "設定", "クレジット", "終了", "音量", "音楽", "反転", "感度", "グラフィック", "解像度", "全画面", "言語", "読み込み中...", "上書きしますか？", "新しく始める", "保存完了", "再開", "操作", "戻る", "品質", "反転", "感度", "ようこそ...", "スロット ", "スロット選択", "(上書き)", "(空き)", "こんにちは...", "ネズミが...", "ありがとう...", "こんにちは...", "忙しい...", "Eを押す", "次へ", "保存", "ネズミ: ", "最低", "低い", "中程度", "高い", "最高", "ウルトラ" },
        #endregion
        #region 7 - 한국어
        { "시작", "계속", "옵션", "크레딧", "종료", "사운드", "음악", "반전", "감도", "그래픽", "해상도", "전체 화면", "언어", "로딩 중...", "덮어쓰기?", "새 게임", "저장됨", "재시작", "조작", "뒤로", "품질", "반전", "감도", "환영합니다...", "슬롯 ", "슬롯 선택", "(덮어쓰기)", "(비어있음)", "안녕...", "쥐가...", "고마워...", "안녕...", "바쁨...", "E 누르기", "계속", "저장", "쥐: ", "매우 낮음", "낮음", "중간", "높음", "매우 높음", "울트라" },
        #endregion
        #region 8 - 简体中文
        { "开始", "继续", "选项", "制作人员", "退出", "音量", "音乐", "反转", "灵敏度", "画面", "分辨率", "全屏", "语言", "载入中...", "覆盖存档？", "新游戏", "已保存", "重启", "控制", "返回", "质量", "反转", "灵敏度", "欢迎...", "槽位 ", "选择槽位", "(覆盖)", "(空)", "你好...", "老鼠...", "谢谢...", "你好...", "正忙...", "按E", "继续", "保存", "老鼠: ", "极低", "低", "中", "高", "超高", "极高" }
        #endregion
    };
    ...
    private void Awake()
    {
        ...
        _languageID = PlayerPrefs.GetInt("Language", 1); // По умолчанию Русский
        Update_texts(); 
    }
    ...
    static public void Update_texts() 
    {
        ...
        foreach (var text in listId)
        {
            if (text != null && text.UIText != null)
            {
                ...
                text.UIText.font = (_languageID == 1) ? Instance.russianFont : Instance.defaultFont;
            }
        }
